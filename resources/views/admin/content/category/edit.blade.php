    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.content.category.update',['postCategory'=>$postCategory->id])}}" method="post" enctype="multipart/form-data" id="form">
                        @csrf
                        @method('PUT')
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="name" id="name" value="{{ $postCategory->name}}">
                                </div>
                                @error('name')
