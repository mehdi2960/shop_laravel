                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td class="width-16-rem text-left d-flex justify-content-center">
                                <a href="{{route('admin.content.category.edit',['postCategory'=>$postCategory->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
                                <form action="{{route('admin.content.category.destroy',['postCategory'=>$postCategory->id])}}" method="post">
                                    @csrf
                                    @method('DELETE')
