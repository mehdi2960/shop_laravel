                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="width-16-rem text-left">
                                <a href="{{route('admin.content.post.edit',['post'=>$post->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
                                <form action="{{route('admin.content.post.destroy',['post'=>$post->id])}}" method="post">
                                    @csrf
                                    @method('DELETE')
