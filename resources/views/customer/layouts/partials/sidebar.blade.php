<aside id="sidebar" class="sidebar col-md-3">
    <form action="{{route('customer.products',['category'=>request()->category?request()->category->id:null])}}" method="get">
        ...
        <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
            ...
            <section class="">
                <input class="sidebar-input-text"
                       type="text" placeholder="جستجو بر اساس نام، برند ..."
        ...
        <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
            ...
            <section class="sidebar-price-range d-flex justify-content-between">
                <section class="p-1">
                    <input type="text" placeholder="قیمت از ..." name="min_price" value="{{request()->min_price}}">
                </section>
                <section class="p-1">
                    <input type="text" placeholder="قیمت تا ..." name="max_price" value="{{request()->max_price}}">
                </section>
            </section>
        </section>
    ...
    <div class="mb-3">
        <a href="{{route('customer.products')}}" class="btn btn-warning d-block">حذف فیلترها</a>
    </div>
</aside>
