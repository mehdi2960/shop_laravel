        ...
        <section class="container-xxl ">
            <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                ...
                <section class="d-flex justify-content-between align-items-center d-md-block">
                    <a class="text-decoration-none" href="/" style="color: #000000;font-weight: bold;font-size: 22px">
                        <img src="{{ asset('customer-assets/images/logo/tik-market.png') }}" alt="" style="width: 150px; height: 40px;">
                    </a>
                    ...
                    <section class="search-box">
                        <section class="search-textbox">
                            ...
                            <form action="{{route('customer.products')}}" method="get">
                                 <input id="search" type="text" value="{{request()->search}}" name="search" placeholder="جستجو ..." autocomplete="off">
                            </form>
                        </section>
                    </section>
                </section>
                                ...
                                <section class="header-cart d-inline ps-3 border-start position-relative">
                                    ...
                                    <section class="header-cart-dropdown">
                                        ...
                                        <section class="header-cart-dropdown-footer border-top d-flex justify-content-between align-items-center p-2">
                                            ...
                                            <section class="">
                                                <a class="btn btn-danger btn-sm d-block" href="{{route('customer.sales-process.cart')}}">ثبت سفارش</a>
                                            </section>
                                        </section>
                                    </section>
                                </section>
...
{{--                    <section class="navbar-item"><a href="#">تخفیف ها و پیشنهادها</a></section>--}}
                    @php
                        $menus=\App\Models\Content\Menu::query()->where('parent_id',null)->where('status',1)->get();
                    @endphp
