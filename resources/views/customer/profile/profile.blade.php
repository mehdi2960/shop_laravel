            ...
            <section class="row">
                ...
                <main id="main-body" class="main-body col-md-9">
                    ...
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                        ...
                        <section class="modal fade" id="edit-profile"
                                 tabindex="-1"
                            ...
                            <section class="modal-dialog">
                                <section class="modal-content">
                                    <section class="modal-header">
                                        <h5 class="modal-title" id="edit-profile-label">
                                            <i class="fa fa-plus"></i> ویرایش حساب کاربری</h5>
                                    ...
                                    <section class="modal-body">
                                        <form class="row" method="post" action="{{ route('customer.profile.profile.update') }}">
                                            ...
                                            <section class="col-6 mb-2">
                                                ...
                                                <input value="{{auth()->user()->national_code ?? auth()->user()->national_code}}"  type="text" name="national_code" class="form-control form-control-sm" id="national_code"placeholder="کد ملی">
                                            </section>
                                    </section>
                                    <section class="modal-footer py-1">
                                        <button type="submit" class="btn btn-sm btn-primary">ویرایش حساب کاربری</button>
