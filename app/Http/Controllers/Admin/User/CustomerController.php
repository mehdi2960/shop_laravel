...
class CustomerController extends Controller
{
    ...
    public function store(CustomerRequest $request,User $user,ImageService $imageService)
    {
        ...
        if ($request->hasFile('profile_photo_path'))
        {
            ...
            if ($result === false) {
                return redirect()->route('admin.user.customer.index')->with('swal-error', 'مشتری جدید با خطا مواجه شد');
            }
    ...
    public function update(CustomerRequest $request,User $user,ImageService $imageService)
    {
        ...
        return redirect()->route('admin.user.customer.index')->with('swal-success', 'مشتری جدید با موفقیت ویرایش شد');
    }
